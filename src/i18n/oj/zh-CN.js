export const m = {
  ...
  What_is_the_meaning_of_submission_execution_time_answer: 'onlinejudge 可能会使用不同的输入文件多次测试您的代码。如果您的代码在每个输入文件的时间限制内给出正确的答案，则显示的执行时间是每个测试用例所花费的最大时间。否则，执行时间将没有参考价值。',
  ...
  Search_Author: '搜索作者',
  Accepted: '答案正确 / AC',
  Time_Limit_Exceeded: '运行超时 / TLE',
  Memory_Limit_Exceeded: '超内存占用 / MLE',
  Runtime_Error: '运行时错误 / RE',
  System_Error: '系统错误 / SE',
  Pending: '等待评分',
  Partial_Accepted: '部分接受 / PA',
  Compile_Error: '编译失败 / CE',
  Rejudge: '重新评分',
  // UserHome.vue
